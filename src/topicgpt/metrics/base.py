...
class BaseMetric(ABC):
    ...
    def __init__(self, dataset, n_docs=10, **kwargs):
        """
        Initialize BaseMetric with dataset and number of documents.
        ...
        dataset : any
            Dataset used for the metric.
        n_docs : int, optional
            Number of documents used in the metric evaluation (default is 10).
